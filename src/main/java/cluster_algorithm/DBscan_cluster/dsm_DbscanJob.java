...
public class dsm_DbscanJob extends Configured implements Tool {
...
//        conf.set("mapreduce.reduce.java.opts","-Xmx6963m");
        ...
        Job job = Job.getInstance(conf,"dsm_DBscanJob");

        //job.setJarByClass(dsm_DbscanJob.class);
    ...
    public static void main(String[] args) throws Exception {
        ToolRunner.run(new Configuration(),new dsm_DbscanJob(),args);
    }
}
