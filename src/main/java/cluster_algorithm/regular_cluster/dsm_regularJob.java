...
public class dsm_regularJob extends Configured implements Tool {
...
//        job.setJarByClass(dsm_regularJob.class);
    ...
    public static void main(String[] args) throws Exception {
        ToolRunner.run(new Configuration(),new dsm_regularJob(),args);
    }
}
