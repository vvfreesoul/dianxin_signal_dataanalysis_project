...
public class dsm_cleanjob extends Configured implements Tool {
...
//        conf.set("mapreduce.job.reduce.memory.mb","10240");
//        conf.set("mapreduce.map.java.opts","-Xmx3480m");
        ...
        Job job = Job.getInstance(conf,"dsm_cleanJob");

        //job.setJarByClass(tripjob.class);
    ...
    public static void main(String[] args) throws Exception {
        ToolRunner.run(new Configuration(),new dsm_cleanjob(),args);
    }
}
